...
def main():
    ...
    feature_columns = [indicator_column(feature_column) for feature_column in feature_columns]
    ...
    if args.input_ckpt_path:
        ...
        model = MMOE(
            feature_columns,
            num_experts=3,
            expert_units_list=[128, 64],
            expert_activation='relu',
            num_towers=1,
            tower_units_list=[128, 64],
